...
window.addEventListener('DOMContentLoaded', function () {
  var parentEl = document.querySelector('.item-wrapper');
  var elements = Array.from(parentEl.querySelectorAll('.item:not(.is-visible)'));
  ScrollTrigger.create({
    trigger: parentEl,
    start: 'top 90%',
    markers: true,
    onEnter: function onEnter() {
      return setImageEffectContent(elements);
    },
    once: true
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "fd285e9365d28aae0fac"; }
/******/ 	}();
/******/ 	
